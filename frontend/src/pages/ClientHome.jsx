...
export default function ClientHome() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      <div className="absolute w-96 h-96 bg-sky-500/10 rounded-full blur-3xl top-0 left-0" />

      <div className="relative z-10 text-center max-w-md w-full">
        <h1 className="text-5xl font-black text-white mb-2">
          Flow<span className="text-sky-400">Q</span>
        </h1>
        <p className="text-slate-400 mb-2">Welcome, {user?.name}</p>
        <p className="text-slate-500 text-sm mb-10">Scan a QR code to join a queue</p>
        ...
        {!scanning ? (
          <button
            ...
            className="bg-sky-500 hover:bg-sky-400 text-white font-bold px-8 py-4 rounded-2xl
              transition-all text-lg flex items-center gap-3 mx-auto"
          >
          ...
          <div className="glass rounded-2xl p-6">
            ...
            <button
              ...
              className="mt-4 text-sm text-red-400 hover:text-red-300 transition-all"
            >
              Cancel
            </button>
          </div>
        ...
        <button onClick={logout} className="mt-8 text-sm text-slate-500 hover:text-slate-400 transition-all">
          Sign out
        </button>
      </div>
    </div>
